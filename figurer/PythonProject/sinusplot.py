...
# Use LaTeX/MiKTeX rendering to match Overleaf fonts
rcParams['text.usetex'] = True
rcParams['font.family'] = 'serif'
rcParams['font.serif'] = ['Computer Modern Roman']
rcParams['font.size'] = 11

# Keep PDF text/vector output high quality
...
points = [
    (0.00, center,             r'\textrm{Peak extension velocity}',  (8, -18)),
    (0.25, center + amplitude, r'\textrm{Upper turnaround}',         (0, 12)),
    (0.50, center,             r'\textrm{Peak retraction velocity}', (18, 18)),
]
...
# Axes
ax.set_xlabel(r'\textrm{Time (one cycle)}', color=C_black)
ax.set_ylabel(r'\textrm{Cylinder position [m]}', color=C_black)
...
out = output_dir / "robustness_reference_trajectory.pdf"
