...
xdot_tests  = [0.014562, 0.038124, 0.044817];
...
fprintf('%-10s  %-12s  %-12s  %-12s  %-12s  %-12s\n', ...
    'Scenario', 'x_dot_ref', 'u_spool', 'u_FF', 'Q_req', 'dP [bar]');
fprintf('%s\n', repmat('-', 1, 74));
...
for i = 1:3
    ...
    elseif x_dot_ref < 0
        ...
        dP      = 0;
        Q_req   = 0;
        fprintf('%-10d  %-12.4f  %-12.6f  %-12.6f  %-12.6e  %-12.2f\n', ...
            i, x_dot_ref, u_spool, u_FF, Q_req, 0);
        continue;
    end
    ...
    fprintf('%-10d  %-12.4f  %-12.6f  %-12.6f  %-12.6e  %-12.2f\n', ...
        i, x_dot_ref, u_spool, u_FF, Q_req, dP/1e5);
end